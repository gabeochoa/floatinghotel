...
set -euo pipefail
cd "$(dirname "$0")/../.."
fixture=$(mktemp -d /tmp/fh-item22.XXXXXX)
...
output/floatinghotel.exe "$fixture" --test-mode --headless --test-script=tests/review_50/item_22.e2e --screenshot-dir=output/screenshots/review_50 --e2e-timeout=40
