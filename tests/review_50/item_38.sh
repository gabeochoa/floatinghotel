...
output/floatinghotel.exe "$search_repo" --test-mode --headless --test-script=tests/review_50/item_38.e2e --screenshot-dir=output/screenshots/review_50 --e2e-timeout=40
