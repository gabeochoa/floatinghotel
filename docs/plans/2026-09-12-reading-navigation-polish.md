...
- [ ] 07. Add close buttons, Cmd+W, and Cmd+Shift+T. Retain 20 closed tabs with reading state. Choose the nearest neighbor when closing; open working changes after the final close.
